...
# Plan-only test bed for Lab 3.3. Do not apply: the KMS key ring cannot be deleted.
terraform {
...
# Compliant: CMEK, uniform access, all four labels. Every policy stays silent.
...
# Non-compliant: no encryption block. SC-28 fires, nothing else.
...
# Non-compliant: public access not locked down. AC-3 fires, nothing else.
...
# Non-compliant: no labels. CM-6 fires, nothing else.
...
# Non-compliant: SSH open to the world. AC-3 fires.
# Multi-line allow block: the one-line comma form is invalid HCL.
